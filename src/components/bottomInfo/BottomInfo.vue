      ...
      footInfoList: [
        {
          ...
          title: '关于我们',
          subTitList: [
            { subTitId: '1', subTit: '发展历程' },
            { subTitId: '2', subTit: '企业文化' },
            { subTitId: '3', subTit: '资质荣誉' },
          ],
        },
        {
          id: '002',
          title: '新闻咨询',
          subTitList: [
            { subTitId: '1', subTit: '行业动态' },
            { subTitId: '2', subTit: '公司新闻' },
          ],
        },
        {
          id: '003',
          title: '联系我们',
          subTitList: [
            { subTitId: '1', subTit: '邮箱' },
            { subTitId: '2', subTit: '电话' },
            { subTitId: '3', subTit: '地址' },
          ],
        },
      ],
    };
